...
Public Class Rep_Aircraft_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AirC.Rep_Aircraft_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_Aircraft_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_Aircraft_list = New Rep_Aircraft_list()
        rpt.Site = Me.Site
        Return rpt
    End Function
