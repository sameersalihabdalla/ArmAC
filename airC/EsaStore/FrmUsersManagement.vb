...
Public Class FrmusersManagement
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        If txt_user_id.Text = "" And btn_save.Text = "Save" Then
...
('" & Me.txt_username.Text.ToString & "', '" & Me.txt_full_name.Text.ToString & "' ,'" & GetHash(Me.txt_password.Text.ToString) & "','" & Me.cactive.Checked & "' ,'" & cprint.Checked & "','" & Cadd.Checked & "','" & cdelete.Checked & "','" & caddusers.Checked & "','" & cedit.Checked & "','" & Me.CmbRole.Text & "')"
        ...
        If txt_user_id.Text <> "" And btn_save.Text = "Save Edit" Then
    ...
    , `add_users_permission`='" & Me.caddusers.Checked.ToString & "', `role`='" & Me.CmbRole.Text & "', `edit_permisson`='" & Me.cedit.Checked.ToString & "'  where user_id = '" & Me.txt_user_id.Text & "'"
            ...
            Dim sure = MsgBox("Do you Want to Save Edit ?", vbYesNo)
    ...
    Private Sub cdelete_CheckedChanged(sender As Object, e As EventArgs) Handles cdelete.CheckedChanged

    End Sub

    Private Sub caddusers_CheckedChanged(sender As Object, e As EventArgs) Handles caddusers.CheckedChanged

    End Sub

    Private Sub cedit_CheckedChanged(sender As Object, e As EventArgs) Handles cedit.CheckedChanged

    End Sub

    Private Sub cprint_CheckedChanged(sender As Object, e As EventArgs) Handles cprint.CheckedChanged

    End Sub

    Private Sub Cadd_CheckedChanged(sender As Object, e As EventArgs) Handles Cadd.CheckedChanged
