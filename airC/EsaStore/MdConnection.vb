...
Module MdConnection
    ...
    Public Function myconn() As MySqlConnection
        ...
        Return New MySqlConnection("server=" & serverip & ";user id=" & dbusername & ";password='" & dbpassword & "';character set=utf8;database=" & dbname & ";sslMode=none")
