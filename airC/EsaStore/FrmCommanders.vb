    ...
    Sub fill_mydata()
        Try
            With Me.DataGridView1.CurrentRow
                ...
                Me.GroupBox2.Text = "Current Commander " & .Cells(1).Value
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        Try
            ...
            If aircraft_id.Text = "" And btn_save.Text = "Save" Then
                ...
                Dim sql As String = "insert tbl_commanders(
    `commander_name`)  values
('" & Me.txt_aircaft_name.Text & "')"
                cmd.Connection = con
                cmd.CommandText = sql
