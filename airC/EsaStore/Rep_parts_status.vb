...
Public Class Rep_parts_status
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AirC.Rep_parts_status.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_parts_status
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_parts_status = New Rep_parts_status()
        rpt.Site = Me.Site
        Return rpt
    End Function
